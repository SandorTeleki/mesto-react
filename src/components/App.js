    ...
    <div className="page">
      ...
      <PopupWithForm name={'add-card-form'} title={'Новое место'} isOpen={isAddPlacePopupOpen} onClose={closeAllPopups}>
        <fieldset className={'popup__inputs'}>
          ...
          <button type="submit" className="popup__submit-button popup__button-disabled" disabled>Сохранить</button>
        </fieldset>
      </PopupWithForm>
      ...
      <PopupWithForm name={'confirm-delete-form'} title={'Вы уверены?'}>
        <fieldset className={'popup__inputs'}>
          <button type="submit" className="popup__submit-button popup__submit-button_type_confirm-delete-form">Да</button>
        </fieldset>
      </PopupWithForm>
